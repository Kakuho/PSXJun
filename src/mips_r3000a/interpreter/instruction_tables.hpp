...
inline void PopulateRegisterInterpreterTable(std::unordered_map<std::uint8_t, Interpreter::RegisterFunction>& rtable){
...
inline void PopulateImmediateInterpreterTable(std::unordered_map<std::uint8_t, Interpreter::ImmediateFunction>& table){
