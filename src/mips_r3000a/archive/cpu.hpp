...
//
// Since PSXJun uses an instruction stepped interprerter, 
// this is also the ochrestrator
...
constexpr inline long CLOCKSPEED = -1;
...
class CPU{
  ...
  private:
    ...
    system::SystemBus* m_sysbus;  // connections to the rest of the system
